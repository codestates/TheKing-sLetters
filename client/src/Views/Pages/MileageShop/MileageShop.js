...
import { fetchItemsData, refineItemsData, fetchItemsBuy, fetchMyItems, refineMyItems } from "./Components/FetchData";
...
const initialItems = [
  {uid: 'a1', name: '[스타벅스] 아이스 아메리카노', image: 'https://i.ibb.co/xjs4zz8/18792f67a6.jpg', qty: 5, price: 1000, selected: 0, items: [1, 2, 3, 4, 5]},
  {uid: 'b2', name: '[카페베네] 카라멜 마키야토', image: 'https://i.ibb.co/xjs4zz8/18792f67a6.jpg', qty: 5, price: 2000, selected: 0, items: [6, 7, 8, 9, 10]},
  {uid: 'c3', name: '[BHC] 뿌링클 치킨', image: 'https://i.ibb.co/xjs4zz8/18792f67a6.jpg', qty: 5, price: 3000, selected: 0, items: [11, 12, 13, 14, 15]},
  {uid: 'd4', name: '[파리바게트] 부드러운 생크림 케이크', image: 'https://i.ibb.co/xjs4zz8/18792f67a6.jpg', qty: 2, price: 4000, selected: 0, items: [16, 17]},
  {uid: 'e5', name: '[파리바게트] 치즈 케이크', image: 'https://i.ibb.co/xjs4zz8/18792f67a6.jpg', qty: 4, price: 4000, selected: 0, items: [18, 19, 20, 21]},
  {uid: 'f6', name: '[카페베네] 녹차 라떼', image: 'https://i.ibb.co/xjs4zz8/18792f67a6.jpg', qty: 4, price: 4000, selected: 0, items: [22, 23, 24, 25]},
  {uid: 'g7', name: '[엔젤리너스] 스위트 아이스 아메리카노', image: 'https://i.ibb.co/xjs4zz8/18792f67a6.jpg', qty: 2, price: 4000, selected: 0, items: [26, 27]},
  {uid: 'h8', name: '[엔젤리너스] 요거트 프라페', image: 'https://i.ibb.co/xjs4zz8/18792f67a6.jpg', qty: 1, price: 4000, selected: 0, items: [28]},
  {uid: 'i9', name: '[엔젤리너스] 초코 프라페', image: 'https://i.ibb.co/xjs4zz8/18792f67a6.jpg', qty: 2, price: 4000, selected: 0, items: [29, 30]},
];
  ...
  return (
    <MileageShopWrapper>
      ...
      {!userLoginSuccess ?
        ...
        <p className="page_error_msg">로그인 정보가 없습니다<br></br>다시 로그인 해주세요</p>
      </div>
      : null}
